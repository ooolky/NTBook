...
class User(AbstractUser):
    ...
    TCount = models.IntegerField(verbose_name='书评发布数量', default=0)
    ...
    TRCount = models.IntegerField(verbose_name='书评评论数量', default=0)
    SRCount = models.IntegerField(
        verbose_name='专题评论数量', default=0)
    Recommend = models.TextField(max_length=1000, verbose_name='推荐列表', blank=True, null=False)
